<template>
    <div>
                                ...
                                <ul class="contacts">
                                    <li v-for="contact in contacts" v-bind:key="contact._id"
                                        ...
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info">
                                                <span v-text="contact.name" style="cursor: pointer;"
                                                    v-bind:data-id="contact._id" v-bind:data-name="contact.name"
                                                    v-bind:data-is-archive="contact.isArchive"
                                                    v-on:click="onChatSelected"></span>
                                                <p v-if="(contact.unreadMessages > 0)"
                                                    v-text="' (' + contact.unreadMessages + ')'" class="text-danger"></p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="col-md-8 col-xl-6 chat">
                        <div class="card">
                            <div class="card-header msg_head">
                                <div class="d-flex bd-highlight">
                                    <div class="user_info">
                                        ...
                                        <p><span v-text="totalMessages"
                                                style="font-size: 10px; color: rgba(255,255,255,0.6);"></span> Messages</p>
                                    </div>
                                </div>
                                    ...
                                    <template v-if="user != null && user.email == msg.sender.email">
                                        <div class="d-flex justify-content-end mb-4">
                                            <div class="msg_cotainer_send">
                                                <template class="more-options" v-on:click="showMoreOptions(msg)"
                                                    v-bind:is-my-message="true">
                                                    <span v-text="msg.message"></span>
                                                </template>

                                                <p class="msg_time message-data-time"
                                                    v-text="getMessageTime(msg.createdAt)"></p>
                                            </div>

                                            <div class="img_cont_msg">
                                                <img v-bind:src="getPicture(msg.sender)"
                            ...
                            <div class="card-footer">
                                <div class="input-group">
                                    <textarea v-model="message" class="form-control type_msg"
                                        placeholder="Type your message..."></textarea>
                                    <div class="input-group-append">
                                        <span class="input-group-text send_btn"><i class="fa fa-location-arrow"
                                                v-on:click="sendMessage"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="contextMenuContactOptions" class="context-menu" style="display: none">
            <ul class="menu">
                <li><a href="javascript:void(0)" v-on:click="deleteContact"><i class="fa fa-trash" aria-hidden="true"></i>
                        Delete</a></li>
            </ul>
        </div>
        ...
        <div id="contextMenu" class="context-menu" style="display: none">
            <ul class="menu">
                <li class="copy"><a href="javascript:void(0)" v-on:click="copyMessage"><i class="fa fa-copy"
